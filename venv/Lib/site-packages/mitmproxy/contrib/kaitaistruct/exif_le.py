...
class ExifLe(KaitaiStruct):
    ...
    class IfdField(KaitaiStruct):
        ...
        def type_byte_length(self):
            ...
            self._m_type_byte_length = (2 if self.field_type == self._root.IfdField.FieldTypeEnum.word else (
                4 if self.field_type == self._root.IfdField.FieldTypeEnum.dword else 1))
            return self._m_type_byte_length if hasattr(self, '_m_type_byte_length') else None
