    ...
    class Message:
        def __init__(self, headers=None):
            self.headers: Optional[
                mitmproxy.net.http.Headers] = headers  # headers are the first thing to be received on a new stream
            ...
            self.trailers: Optional[
                mitmproxy.net.http.Headers] = None  # trailers are received after stream_ended is set
