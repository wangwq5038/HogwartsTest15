    ...
    <div class="col-md-9">
        ...
        <li class="media">
            ...
            <div class="media-body">
                ...
                <a class="btn btn-sm btn-success" href="/cert/{{ filetype }}" target="_blank">🔏 Get
                    mitmproxy-ca-cert.{{
                    filetype }}</a>
                <a class="btn btn-sm btn-info show-instructions" href="#{{ title.split(' ')[0] }}"
                   id="{{ title.split(' ')[0] }}">📖
                    Show Instructions</a>
        ...
        <ul class="list-unstyled">
            ...
            <ol>
                ...
                <li>Select a certificate store location. This determines who will trust the certificate &ndash; only the
                    current
            ...
            <ol>
                <li>Run <code>certutil.exe -importpfx Root mitmproxy-ca-cert.p12</code>
            ...
            <h5>iOS 13+</h5>
            <ol>
                <li>Use Safari to download the certificate. Other browsers may not open the proper installation
                    prompt.
                </li>
            ...
            <p>Some Android distributions require you to install the certificate via <samp>Settings -> Security ->
                Advanced ->
                Encryption and credentials -> Install from storage</samp> instead.</p>

            <div class="alert alert-warning" role="alert">
                <p><strong>Warning: </strong>Apps that target Android API Level 24 (introduced in 2016) and above only
                    accept
                    certificates from the system trust store
                    (<a href="https://github.com/mitmproxy/mitmproxy/issues/2054">#2054</a>).
                    User-added CAs are not accepted unless the application manually opts in. Except for browsers, you
                    need to
