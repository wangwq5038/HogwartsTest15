...
from ..protocol.rfc4511 import CompareRequest, AttributeValueAssertion, AttributeDescription, LDAPDN, AssertionValue, \
    ResultCode
...
def compare_operation(dn,
    ...
    ava['assertionValue'] = AssertionValue(prepare_for_sending(
        validate_attribute_value(schema, attribute, value, auto_encode, validator, check_names=check_names)))
