        ...
        try:
            ...
            if self.result['result'] == RESULT_SUCCESS:
                ...
                if self.connection.raise_exceptions:
                    ...
                    raise LDAPOperationResult(result=self.result['result'], description=self.result['description'],
                                              dn=self.result['dn'], message=self.result['message'],
                                              response_type=self.result['type'])
