...
def edir_remove_members_from_groups(connection,
    ...
    if not error:
        for member in members_dn:
            ...
            changes = dict()
            security_equals_to_remove = [element for element in groups_dn if
                                         element.lower() in existing_security_equals]
            group_membership_to_remove = [element for element in groups_dn if
                                          element.lower() in existing_group_membership]
    ...
    if not error:
        for group in groups_dn:
            ...
            equivalent_to_me_to_remove = [element for element in members_dn if
                                          element.lower() in existing_equivalent_to_me]
            if member_to_remove:
