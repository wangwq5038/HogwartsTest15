...
class ValidationNotEqualError(ValidationFailedError):
    ...
    def __init__(self, expected, actual, io, src_path):
        super(ValidationNotEqualError, self).__init__(
            "not equal, expected %s, but got %s" % (repr(expected), repr(actual)), io, src_path)
...
class ValidationLessThanError(ValidationFailedError):
    ...
    def __init__(self, min, actual, io, src_path):
        super(ValidationLessThanError, self).__init__("not in range, min %s, but got %s" % (repr(min), repr(actual)),
                                                      io, src_path)
        self.min = min
        self.actual = actual
...
class ValidationGreaterThanError(ValidationFailedError):
    ...
    def __init__(self, max, actual, io, src_path):
        super(ValidationGreaterThanError, self).__init__("not in range, max %s, but got %s" % (repr(max), repr(actual)),
                                                         io, src_path)
        self.max = max
        self.actual = actual
